...
const DEFAULT_CONFIG = {
  ...
  sys: {
    ...
    urls: {
      ...
      // virtual contest
      vcontestpage:              'https://leetcode.com/contest/$contest',
      vcontestapi:               'https://leetcode.com/contest/api/info/$contest',
      vparticipate:              'https://leetcode.com/contest/api/$contest/virtual_participate',
      vsubmit:                   'https://leetcode.com/contest/api/$contest/problems/$slug/submit/',
      vtest:                     'https://leetcode.com/contest/api/$contest/problems/$slug/interpret_solution/',
      vmyrank:                   'https://leetcode.com/contest/api/myranking/$contest?region=global'
    },
  },
